package com.bookplus.auth.architecture;
 ...
 */
@AnalyzeClasses(packages = "com.bookplus.auth", importOptions = ImportOption.DoNotIncludeTests.class)
class HexagonalArchitectureTest {
    ...
    static final ArchRule los_casos_de_uso_estan_en_application_usecase =
            classes().that().areAnnotatedWith(com.bookplus.auth.shared.annotation.UseCase.class)
