package com.bookplus.cart.architecture;
 ...
 */
@AnalyzeClasses(packages = "com.bookplus.cart", importOptions = ImportOption.DoNotIncludeTests.class)
class HexagonalArchitectureTest {
    ...
    // cart-service no usa JPA (persistencia en Redis), por eso no hay regla de @Entity.

    @ArchTest
    static final ArchRule los_casos_de_uso_estan_en_application_usecase =
            classes().that().areAnnotatedWith(com.bookplus.cart.shared.annotation.UseCase.class)
