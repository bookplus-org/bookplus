...
public class SecurityConfig {
    ...
    public JwtDecoder jwtDecoder() {
        try {
            ...
            throw new IllegalStateException("Cannot load RSA public key for payment-service", ex);
        }
    }
